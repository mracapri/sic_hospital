...
@Transactional
public class TestUnidadMedicaDao {
	@Autowired
	UnidadMedicaDao unidadMedicaDao;
	
	@Test
	public void testUnidadMedicaReadDao(){				
		
		UnidadMedica read = unidadMedicaDao.read(1);		
		boolean resultado = read.getDescripcion().equals("Acreditada");
	...
	public void testUnidadMedicaReturnAllDao(){								
		...
		/*Get all*/
		List<UnidadMedica> findAll = unidadMedicaDao.findAll();
